...
import { 
  ...
  HelpCircle, Trash2, Check, AlertTriangle, AlertCircle, Loader2 
} from 'lucide-react';
...
export default function BookProject() {
  ...
  const handleSubmitProposal = async (e) => {
    ...
    try {
      ...
      formData.append('stack', letTeamChooseStack ? 'Team Choice (TBD)' : `${selectedFrontend}, ${selectedBackend}, ${selectedDatabase}`);
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div className="dash-card">
        ...
        {step === 3 && (
          <div>
            <h3 style={{ fontFamily: 'var(--dash-font-display)', fontSize: '1.4rem', marginBottom: '4px' }}>Upload Project Brief</h3>
            <p style={{ fontSize: '0.85rem', color: 'var(--dash-text-sec)', marginBottom: '24px' }}>
              Upload project specs or images (Max 10MB, up to 5 files).
            </p>
        ...
        {step === 5 && (
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div className="dash-card" style={{ background: 'var(--dash-card-sec)' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                  <h4 style={{ fontSize: '0.88rem', textTransform: 'uppercase', color: 'var(--dash-text-sec)', margin: 0 }}>3. Attached Files</h4>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid var(--dash-border)', paddingTop: '20px', marginTop: '32px' }}>
          ...
          {step < 5 ? (
            ...
            <button 
              ...
              disabled={submitting}
              style={{ background: 'var(--dash-success)', color: '#fff' }}
            >
              {submitting ? (
